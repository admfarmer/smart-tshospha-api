...
app.register(require('./routes/category'), { prefix: '/category', logger: true });
app.register(require('./routes/documents'), { prefix: '/documents', logger: true });
app.register(require('./routes/group'), { prefix: '/group', logger: true });
